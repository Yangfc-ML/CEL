...
import PIL.Image
from data.dataset_dogs import Dogs


def load_dogs120(args):
    ...
    original_train = Dogs(root='../data', train=True, cropped=False, transform=test_transform, download=True)
    ...
    test_dataset = Dogs(root='../data', train=False, cropped=False, transform=test_transform, download=True)
    ...
    model.load_state_dict(
        torch.load(os.path.expanduser('weight/dogs120/dogs120.pt'))['model_state_dict'])
