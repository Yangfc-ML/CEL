...
def load_cub200(args):
    ...
    original_train = Cub2011('../data', train=True, transform=test_transform, loader=pil_loader)
    ...
    test_dataset = Cub2011('../data', train=False, transform=test_transform, loader=pil_loader)
    ...
    model.load_state_dict(
        torch.load('weight/cub200/cub200.pt')['model_state_dict'])
